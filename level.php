		...
		<?php
			...
			for ($i = 1; $i <= 3; $i++) {
				if ($i <= $level) {
					...
					echo '<a class="level" id="level' .$i. '" rel="external"><i id="lock" class="material-icons">lock</i></a>';
				}
			}
		?>
	</div>
	...
	<div id="endless">
		<?php 
			...
			if ($level == 4) {
				...
				echo '<a id="endlessBtn" rel="external"><i id="lock" class="material-icons">lock</i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Endless</a>';
			}
		?>
	</div>
